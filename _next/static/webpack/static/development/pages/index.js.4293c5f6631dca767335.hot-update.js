...
var useQuestions = function useQuestions() {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])({}),
      ...
      setAnswers = _useState3[1]; // loadAnswersFromUrl


  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    var defaultAnswersHasLoaded = Object.keys(answers).length > 0;
    var hasUrlData = Object.keys(urlData).length > 0;

    if (!hasUrlData || !defaultAnswersHasLoaded || hasReceivedInput) {
      return;
    }
  ...
  }, [urlData, answers, answeredQuestions, hasReceivedInput]); // load initial default data

  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    var hasLoadedAnswers = Object.keys(answers).length === 0;

    if (hasReceivedInput || hasLoadedAnswers) {
      return;
    }

    if (Object.keys(answers).length === 0) {
      var _defaultAnswers = getInitialAnswers(urlData);

      setAnswers(_defaultAnswers);
    }
...
//# sourceMappingURL=index.js.4293c5f6631dca767335.hot-update.js.map