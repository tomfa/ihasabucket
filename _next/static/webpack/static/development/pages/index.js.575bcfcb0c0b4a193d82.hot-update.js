...
function Home() {
  ...
  }, _utils_questions__WEBPACK_IMPORTED_MODULE_7__["questions"].slice(0, questionRenderCount).map(function (question) {
    var isLast = _utils_questions__WEBPACK_IMPORTED_MODULE_7__["questions"].indexOf(question) === questionRenderCount - 1;

    if (question.type === 'radio') {
      var answerValue = selectedRadioOptions[question.id] || null;

      if (answerValue && isLast) {
...
//# sourceMappingURL=index.js.575bcfcb0c0b4a193d82.hot-update.js.map