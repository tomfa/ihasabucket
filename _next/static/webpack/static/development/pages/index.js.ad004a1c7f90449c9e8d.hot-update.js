...
function Home() {
  ...
  var hasAnsweredAll = questionRenderCount + 1 === _utils_questions__WEBPACK_IMPORTED_MODULE_7__["questions"].length;
  console.log(questionRenderCount, _utils_questions__WEBPACK_IMPORTED_MODULE_7__["questions"].length);
  return __jsx(_components_utils__WEBPACK_IMPORTED_MODULE_2__["PageWrapper"], {
    ...
    var isLast = indexOfAllQuestions === questionRenderCount + 1;
    ...
    if (shouldSkip) {
      if (isLast) {
        console.log('AUTOMATIC FOR', question);
        setQuestionRenderCount(function (q) {
          return Math.min(q + 1, question.length);
        });
      }
    ...
    if (question.type === 'radio') {
      ...
      return __jsx(_components_forms_RadioGroup__WEBPACK_IMPORTED_MODULE_5__["default"], {
        ...
        onChange: function onChange(value) {
          setQuestionRenderCount(indexOfAllQuestions + 1);
...
//# sourceMappingURL=index.js.ad004a1c7f90449c9e8d.hot-update.js.map