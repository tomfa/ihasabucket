...
var getTerraFormPackage = function getTerraFormPackage(props) {
  var createFolders = {
    description: 'First, create a folder for your infrastructure code.',
    tfContent: ['mkdir infrastructure', 'cd infrastructure']
  };
  var mainContent = {
    description: 'Then, create a terraform config file',
  ...
  var loadTerraformModules = {
    description: 'Download the required modules',
    tfContent: ['terraform init']
  };
  var initialDnsDeploy = {
    description: 'Create the DNS servers',
    tfContent: ['terraform init', 'terraform deplpy']
  };
  var deploy = {
    description: 'Deploy to AWS',
    tfContent: ['terraform deplpy']
  };
  return {
    sections: [createFolders, mainContent, loadTerraformModules, props.configureDns && initialDnsDeploy, deploy].filter(function (m) {
      return m;
    }),
...
//# sourceMappingURL=index.js.e5cfadd88719fb12c137.hot-update.js.map