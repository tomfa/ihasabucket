...
var getCertificateWarning = function getCertificateWarning(props) {
  ...
  if (props.configureDns) {
    return 'During the setup, we will request HTTPS certificates for your domain, and verify that they are set up correctly. ' + 'This means that the DNS changes you made has to have propagated before it will complete. Until then, the script will not complete. ' + 'Instead, it may time out. No worries though, just re-run the script after a while, when the DNS records are correct. ' + 'It will continue where it left off.';
  }
...
//# sourceMappingURL=index.js.e584bfe88ed572e7992e.hot-update.js.map