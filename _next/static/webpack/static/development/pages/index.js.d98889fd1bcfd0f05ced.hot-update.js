...
var getFAQuestions = function getFAQuestions(summary) {
  ...
  return [{
    ...
    }, "S3 and Cloudfront are basic, cheap infrastructure. Since AWS charges per use, it's impossible to say exactly, but 1$ per month would likely covers 1000 monthly users."), __jsx("p", {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 46,
    ...
    }, "If you have recently signed up for AWS, the expenses will commonly be included in the free tier and you won't pay anything at all."))
  }, {
...
//# sourceMappingURL=index.js.d98889fd1bcfd0f05ced.hot-update.js.map