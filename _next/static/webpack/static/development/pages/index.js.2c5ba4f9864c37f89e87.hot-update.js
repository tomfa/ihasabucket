...
var useUrlState = function useUrlState() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    ...
    if (hasChanged(urlData, newData)) {
      console.log('setting it', newData);
      setUrlData(newData);
    } else {
...
var getDataFromUrlQuery = function getDataFromUrlQuery(parsedUrlQuery) {
  ...
  var urlState = {};
  console.log('parsedUrlQuery', parsedUrlQuery);
...
var hasChanged = function hasChanged(oldData, newData) {
  var changed = JSON.stringify(oldData) !== JSON.stringify(newData);
...
//# sourceMappingURL=index.js.2c5ba4f9864c37f89e87.hot-update.js.map