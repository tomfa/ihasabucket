...
})(["&[type='checkbox']{width:1px;height:1px;outline:none;border:none;opacity:0;}&[type='radio']{width:1px;height:1px;outline:none;border:none;opacity:0;}&[type='text']{padding:1rem;flex:1;border:none;font-size:1.2rem;&:focus{margin-right:3px;outline:2px dashed ", ";}}&:focus + ", "{outline:2px dashed ", ";}"], function (p) {
...
//# sourceMappingURL=index.js.a5a465823dd0dbca4e40.hot-update.js.map